...
void setup() {
  ...
  String file =  sketchPath("") + "/2017-05-13-17-09-44.fit";
...
class Listener implements FileIdMesgListener, UserProfileMesgListener, DeviceInfoMesgListener, MonitoringMesgListener, RecordMesgListener, DeveloperFieldDescriptionListener, CameraEventMesgListener, GyroscopeDataMesgListener {
  ...
  @Override
   ...
   // System.out.println( "HeartRateFieldNum" );
    printValues( mesg, RecordMesg.HeartRateFieldNum );
   // System.out.println( "CadenceFieldNum" );
    printValues( mesg, RecordMesg.CadenceFieldNum );
   // System.out.println( "DistanceFieldNum" );
